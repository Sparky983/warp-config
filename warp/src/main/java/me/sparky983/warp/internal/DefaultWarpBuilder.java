...
/**
 * The default implementation of {@link Warp.Builder}.
 *
 * @param <T> the type of the {@linkplain Configuration configuration class}
 */
public final class DefaultWarpBuilder<T> implements Warp.Builder<T> {
  ...
  /**
   * Constructs a {@code DefaultWarpBuilder} for the given {@link Schema}.
   *
   * @param schema the schema
   * @throws NullPointerException if the {@link Schema} is {@code null}.
   */
  public DefaultWarpBuilder(final Schema<? extends T> schema) {
  ...
  @Override
  public Warp.Builder<T> source(final ConfigurationSource source) {
  ...
  @Override
  public <D> Warp.Builder<T> deserializer(
